...
This document is an intro to the way I  , my [[psychological]](https://github.com/winslowb/winslowb/blob/dis.md) and [[operational]](https://github.com/winslowb/winslowb/blob/master/DevOps-principles.md) framework. It will be succesfull if it aids in building a better working relationship. I'm aware that all of our experiences predicate this moment and determines our leadership and engagement style.
